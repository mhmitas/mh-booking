        ...
        <div className="custom-container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              We offer a diverse range of experiences tailored to your
              preferences and desires. From luxurious accommodations to
              thrilling adventures, we have something for everyone.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {categories.map((category: ICategory) => (
              <ServiceCard key={category._id.toString()} category={category} />
            ))}
          </div>
        </div>
      </section>
